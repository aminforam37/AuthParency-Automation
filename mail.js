...
export async function sendMail(testResults) {
    ...
    const emailContent = `
        <html>
            <body>
                <p>Hi All,</p>
                <p>Here are the testing results of all the available modules of <a href="https://dev-outamateds.outamationlabs.com/">AuthParency URL</a>.</p>
    ...
    const mailOptions = {
        ...
        subject: hasFailures
            ? 'Failed: PA - Web UI Playwright Automation Flow Result'
            : 'PA - Web UI Playwright Automation Flow Result',
        html: emailContent,
