...
test('@Authparency: CreatedOrder', async ({ page }) => {
    ...
    //Delete
    await page.locator('i[title="Delete"]').nth(5).click();
    await page.waitForTimeout(1000);
  ...
  await page.waitForTimeout(1000); 
          ...
          if (page.url().includes('https://demo.authparency.com/create-order#/')) 
        { 
        ...
        addResult({
            ...
            status: 'Pass',
            URL: '<a href="https://demo.authparency.com/create-order#/">Order Creation</a>'
        });
    } else {
        addResult({
            srNo: '3',
...

  {
   ...
   //await sendMail(testResults);
      ...
      await page.waitForTimeout(1000); 
        ...
        const Order_ReqFN = await page.locator('input[id="reqname"]').inputValue();
        ...
        //console.log(Order_ReqAddress);
         const Order_RenFN = await page.locator('input[id="sername"]').inputValue();
